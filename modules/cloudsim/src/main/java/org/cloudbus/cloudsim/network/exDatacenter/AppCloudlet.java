...
public class AppCloudlet {
	...
	public static final int APP_BigData = 9;
	
	public  int is_proccessed = 0;
	
	/**
	 * Each row i of this attribute shows the VMs that VMi 
	 * will send them data.
	 */
	...
	public void addCloudletToList(NetworkCloudlet cl) {
		NetworkConstants.currentCloudletId++;
		cl.setUserId(userId);
		cl.submittime = CloudSim.clock();
		cl.currStagenum = -1;
